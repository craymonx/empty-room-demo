...
export default {
    enter({ root, go }) {
      ...
      function showNextButton() {
        ...
        nextBtn.className = "room8-next-btn";
        nextBtn.type = "button";
      ...
      function render() {
        ...
        if (scene === "mainCloudy") {
          createProp("sprayItem", ASSETS.props.sprayFull, RECTS.props.spray, true);
        ...
        if (scene === "sunnyWaterLeak2") {
          createProp("sprayItem", ASSETS.props.sprayHalf, RECTS.props.spray, true);
